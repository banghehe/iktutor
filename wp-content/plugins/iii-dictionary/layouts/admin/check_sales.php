		...
		<div class="col-xs-12 box box-sapphire">
			<table class="table table-striped table-style1 text-center">
				...
				<tbody>
					...
					<tr>
						<td>IK Math</td>
						<td><?php echo number_format($report['total']['ikmath']['pre']->amount, 1) ?></td>
						<td><?php echo number_format($report['this_month']['ikmath']['pre']->amount, 1) ?></td>
						<td><?php echo number_format($report['last_month']['ikmath']['pre']->amount, 1) ?></td>
						<td><?php echo number_format($report['2m_ago']['ikmath']['pre']->amount, 1) ?></td>
						<td><?php echo number_format($report['3m_ago']['ikmath']['pre']->amount, 1) ?></td>
						<td><?php echo number_format($report['4m_ago']['ikmath']['pre']->amount, 1) ?></td>
						<td><?php echo number_format($report['6m_ago']['ikmath']['pre']->amount, 1) ?></td>
						<td><?php echo number_format($report['below_6m']['ikmath']['pre']->amount, 1) ?></td>
					</tr>
					<tr>
						<td>IK Math - Test</td>
						<td><?php echo number_format($report['total']['ikmath']['test']->amount, 1) ?></td>
						<td><?php echo number_format($report['this_month']['ikmath']['test']->amount, 1) ?></td>
						<td><?php echo number_format($report['last_month']['ikmath']['test']->amount, 1) ?></td>
						<td><?php echo number_format($report['2m_ago']['ikmath']['test']->amount, 1) ?></td>
						<td><?php echo number_format($report['3m_ago']['ikmath']['test']->amount, 1) ?></td>
						<td><?php echo number_format($report['4m_ago']['ikmath']['test']->amount, 1) ?></td>
						<td><?php echo number_format($report['6m_ago']['ikmath']['test']->amount, 1) ?></td>
						<td><?php echo number_format($report['below_6m']['ikmath']['test']->amount, 1) ?></td>
					</tr>
				</tbody>
			</table>
		</div>
