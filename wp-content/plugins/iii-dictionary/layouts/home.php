                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 body-tab boxshadow-tab" onclick="location.href = 'https://iktutor.com/ikteach/en/<?php echo $link ?>'">
                        <div class="class-to-ikteacher">
                            <div class="wrapp-img">
                                ...
                                <button class="btn-blue btn-group border-ras">TEACHERS & TUTORS</button>
                            </div>
                            <div class="intro-page">
                                <h3>Online Tutoring & Classroom Management Software</h3>
                                <ul class="intro-item">
                                    <li class="clearfix"><img src="<?php echo get_template_directory_uri(); ?>/library/images/Icon_Check_Gray.png" name="ikteacher"><span>Tutor Students Online (opportunity to earn money)</span></li>
                                    <li class="clearfix"><img src="<?php echo get_template_directory_uri(); ?>/library/images/Icon_Check_Gray.png" name="ikteacher"><span>Use Classroom Management System</span></li>
                                    <li class="clearfix"><img src="<?php echo get_template_directory_uri(); ?>/library/images/Icon_Check_Gray.png" name="ikteacher"><span>Use Math and English Library to Teach Students</span></li>
                                </ul>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 body-tab" onclick="location.href = 'https://iktutor.com/iklearn/en/<?php echo $link ?>'">
                        <div class="class-to-ikstudy">
                            ...
                            <div class="wrapp-img">
                               ...
                               <button class="btn-orange btn-group border-ras ">STUDENTS</button>
                            </div>
                            <div class="intro-page">
                                <h3>Select a Tutor or Join an Online Class</h3>
                                <ul class="intro-item">
                                    <li class="clearfix"><img src="<?php echo get_template_directory_uri(); ?>/library/images/Icon_Check_Gray.png" name="ikteacher"><span>Select a Tutor for One on One Help</span></li>
                                    <li class="clearfix"><img src="<?php echo get_template_directory_uri(); ?>/library/images/Icon_Check_Gray.png" name="ikteacher"><span>Join Various Online Classes Taught by Teachers</span></li>
                                    <li class="clearfix"><img src="<?php echo get_template_directory_uri(); ?>/library/images/Icon_Check_Gray.png" name="ikteacher"><span>Complete Math and English Learning</span></li>
                                </ul>
                                <div class="form-group">
