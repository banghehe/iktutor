...
// Save email
if(isset($_POST['save_email'])){ // Save and Send test email
	...
	ik_enqueue_messages(__('Save email marketing successfully.','iii-dictionary'),'error');
...
if(isset($_POST['test_send_email'])){ // Save and Send test email
	...
	if($email_test != ''){
		...
		ik_enqueue_messages(__('You have not type test email address.','iii-dictionary'),'notice');
		wp_redirect(site_admin_url().'?r=email-marketing');
		exit;
	}
	...
	<form method="post" action="<?php echo site_admin_url(); ?>?r=email-marketing" id="form_email_marketing" enctype="multipart/form-data">
		<div class="row">
			...
			<div class="col-md-7 col-sm-7 col-xs-12">
				<div class="form-group">
					<button class="btn btn-default orange form-control" type="submit" id="save_email" name="save_email"><span class="glyphicon glyphicon-floppy-save" style="margin-right: 5px;"></span> <?php _e('Save','iii-dictionary'); ?></button>
				</div>
			</div>
			<div class="col-md-5 col-sm-5 col-xs-12">
				<div class="form-group">
					<button class="btn btn-default orange form-control" type="submit" id="send_restart" name="send_restart"><span class="glyphicon glyphicon-floppy-save" style="margin-right: 5px;"></span> <?php _e('Send','iii-dictionary'); ?></button>
				</div>
			</div>
			<div class="col-md-7 col-sm-7 col-xs-12" style="text-align:right">	
				<label style="padding:5px 0">
					...
					if($total_sent_out > '0'){
						...
						_e('We\'ve not send','iii-dictionary');
						echo ' ';
						_e('any email in list','iii-dictionary');
						echo ' '.mw_get_option('total_emails_marketing').' ';
						_e('emails.','iii-dictionary');
					}
					?> 
			...
			<div class="col-md-5 col-sm-5 col-xs-12">
				<div class="form-group">
					...
					<?php }else{ ?>
						<button class="btn btn-default orange form-control" type="submit" id="btn_save" name="btn_save"><span class="glyphicon glyphicon-floppy-save" style="margin-right: 5px;"></span> <?php _e('Send the next','iii-dictionary'); ?> <?php echo mw_get_option('rate_email'); ?></button>
					<?php 
						} 
					}?>
			...
			<div class="col-md-5 col-sm-5 col-xs-12">
					<div class="form-group">
						<button class="btn btn-default orange form-control" type="submit" id="test_send_email" name="test_send_email"><span class="glyphicon glyphicon-floppy-save" style="margin-right: 5px;"> </span><?php _e('Send','iii-dictionary'); ?></button>
				</div>
			</div>
		</div>
