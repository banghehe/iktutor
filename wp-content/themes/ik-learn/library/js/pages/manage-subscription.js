	...
	$(function(){
		if(window.location.hash != ""){
			...
			show_subscription_panel(_v);
                        if(_v==12||_v==8||_v==7||_v==4||_v==3||_v==2||_v==1||_v==0){
                            $("#step3-collapse").collapse();
                            
                            if(_v==3 && window.location.hostname.search('math')!=-1){
			...
			switch(id){
				...
				case 8: $("#self-study-detail").slideUp();
					...
					$("#sat-ii-detail").slideDown();
                                        $("#ik-class-detail").slideUp();
					break;
				case 12: $("#self-study-detail").slideUp();
					$("#teacher-detail").slideUp();
					$("#purchase-points-detail").slideUp();
					$("#sat-i-detail").slideUp();
					$("#sat-ii-detail").slideUp();
		...
		$("#val-credit-code").click(function(e){
                    e.preventDefault();
			var tthis = $(this);
			var $c = $("#credit-code");
			var code = $c.val().trim();
		...
		$('#apply-credit-code').click(function(e) {
                    e.preventDefault();
			...
			switch(t){
				...
				case 12:
					...
					switch(typeid){
						...
						case 10: $("#sat-test-i-block").show(); $("#sat-test-ii-block").hide();$("#ik-test-class-block").hide(); break;
						case 16: $("#sat-test-ii-block").show(); $("#sat-test-i-block").hide();$("#ik-test-class-block").hide(); break;
						case 38: $("#ik-test-class-block").show(); $("#sat-test-i-block").hide();$("#sat-test-ii-block").hide(); break;
		...
		$("#student_num, #sel-dictionary").change(function(){
			calc_total_price();
		});
                $("#sel-teacher-tool").change(function(){
		...
		function calc_sat_total_price(){
			...
			switch(d){
				...
				case "38": p = satMIKP; break;
                                case "39": p = satMIKP1; break;
                                case "40": p = satMIKP2; break;
                                case "41": p = satMIKP3; break;
                                case "42": p = satMIKP4; break;
                                case "43": p = satMIKP5; break;
                                case "44": p = satMIKP6; break;
                                case "45": p = satMIKP7; break;
                                case "46": p = satMIKP8; break;
                                case "47": p = satMIKP9; break;
                                case "48": p = satMIKP10; break;
                                case "49": p = satMIKP11; break;
                                case "50": p = satMIKP12; break;
