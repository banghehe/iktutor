                            ...
                            <div class="row box-header">
                                <div class="col-xs-12">
                                    <div class="row search-tools">
                                        ...
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="form-group">
                                                <?php MWHtml::sel_assignments($filter['assignment-id'], false, array(), __('-Assignment-', 'iii-dictionary'), 'filter[assignment-id]', 'select-sapphire form-control', 'filter-assignment') ?>
                                            </div>
                                        </div>
                                        <div class="col-xs-6 col-sm-3">
                                            <div class="form-group">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="hidden-xs" style="min-width: 80px">
                                                        <a href="#" class="sortable<?php echo $filter['orderby'] == 'grade' ? ' ' . $filter['order-dir'] : '' ?>" data-sort-by="grade"><?php _e('Grade', 'iii-dictionary') ?> <span class="sorting-indicator"></span></a>
                                                    </th>
                                                    <th class="hidden-sm"><?php _e('Dictionary', 'iii-dictionary') ?></th>
                                                    <th>
                                                        <a href="#" class="sortable<?php echo $filter['orderby'] == 'sheet_name' ? ' ' . $filter['order-dir'] : '' ?>" data-sort-by="sheet_name"><?php _e('Sheet Name', 'iii-dictionary') ?> <span class="sorting-indicator"></span></a>
                                                    </th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                ...
                                <div class="row search-tools">
                                    ...
                                    <div class="col-sm-4 form-group">
                                        <select class="select-box-it select-sapphire form-control" name="filter[cat-level]" id="filter-level-categories">
                                            <option value=""><?php _e('-Level Category-', 'iii-dictionary') ?></option>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <select class="select-box-it select-sapphire form-control" name="filter[level]" id="filter-levels" data-selected="<?php echo $filter['level'] ?>">
                                            <option value=""><?php _e('-Level-', 'iii-dictionary') ?></option>
                                        </select>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <select class="select-box-it select-sapphire form-control" id="filter-sublevels" name="filter[sublevel]" data-selected="<?php echo $filter['sublevel'] ?>">
                                            <option value=""><?php _e('-Sublevel-', 'iii-dictionary') ?></option>
                                        </select>
                            ...
                            <div class="col-xs-12">
                                <div class="scroll-list2" style="max-height: 600px">
                                    <table class="table table-striped table-condensed ik-table1 vertical-middle text-center">
                                        <thead>
                                            <tr>
                                                <th class="hidden-xs"><?php _e('Level Category', 'iii-dictionary') ?></th>
                                                <th class="hidden-xs">
                                                    <a href="#" class="sortable<?php echo $filter['orderby'] == 'level_name' ? ' ' . $filter['order-dir'] : '' ?>" data-sort-by="level_name"><?php _e('Level', 'iii-dictionary') ?> <span class="sorting-indicator"></span></a>
                                                </th>
                                                <th class="hidden-xs">
                                                    <a href="#" class="sortable<?php echo $filter['orderby'] == 'sublevel_name' ? ' ' . $filter['order-dir'] : '' ?>" data-sort-by="sublevel_name"><?php _e('Sublevel', 'iii-dictionary') ?> <span class="sorting-indicator"></span></a>
                                                </th>
                                                <th class="hidden-xs">
                                        ...
                                        <tbody><?php if (empty($avail_sheets)) : ?>
                                                ...
                                                <?php
                                                    ...
                                                    ?><tr<?php echo $sheet->active ? '' : ' class="hidden"' ?> data-id="<?php echo $sheet->id ?>" 
                                                                                                             ...
                                                                                                             endif;  ?>><?php ?><td class="hidden-xs"><?php echo $sheet->level_category_name ?></td><?php ?><td><?php echo $sheet->level_name ?></td><?php ?><td class="hidden-xs"><?php echo $sheet->sublevel_name ?></td><?php ?><td class="hidden-xs"><?php echo $sheet->type ?></td><?php ?><td class="hidden-xs"><?php echo $sheet->sheet_name ?></td><?php ?><td><?php
