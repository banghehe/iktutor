					...
					<div class="row">
						<div class="col-xs-12">
							<div class="" style="max-height: 600px;overflow: auto;">
								<table class="table table-striped table-condensed ik-table1 text-center scroll-fix-head" id="list-sheets">
									<thead>
										<tr>
											<th class="list-sheet-css1"><input type="checkbox" class="check-all" data-name="mid[]"></th>
											<th class="list-sheet-css2">Status</th>
											<th class="list-sheet-css3"><?php echo $filter['type'] == 'received' ? 'Sender' : 'Recipient' ?></th>
											<th class="list-sheet-css4">Subject</th>
											<th class="list-sheet-css5"><?php echo $filter['type'] == 'received' ? 'Received' : 'Sent' ?> Date</th>
											<th></th>
										</tr>
									</thead>
									<tfoot>
